...
// KnativeAgentSpec is the desired state of a tenant agent. Implements
// R-OP-API-1.
...
// KnativeAgentStatus is the observed state. R-OP-FF-3.
...
// KnativeAgent is the namespaced top-level CR.
type KnativeAgent struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   KnativeAgentSpec   `json:"spec,omitempty"`
	Status KnativeAgentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// KnativeAgentList is a list of KnativeAgent objects.
type KnativeAgentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []KnativeAgent `json:"items"`
}

func init() {
	SchemeBuilder.Register(&KnativeAgent{}, &KnativeAgentList{})
}
