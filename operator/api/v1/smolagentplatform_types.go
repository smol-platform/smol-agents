...
// SmolAgentPlatformSpec carries cluster-wide defaults and the
...
type EBPFLoaderSpec struct {
	...
	// +kubebuilder:default:="/sys/fs/bpf/smol-agents"
...
// SmolAgentPlatformStatus reports operator health at cluster scope.
type SmolAgentPlatformStatus struct {
...
// SmolAgentPlatform is the cluster-scoped platform CR.
type SmolAgentPlatform struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   SmolAgentPlatformSpec   `json:"spec,omitempty"`
	Status SmolAgentPlatformStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SmolAgentPlatformList is a list of SmolAgentPlatform objects.
type SmolAgentPlatformList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SmolAgentPlatform `json:"items"`
}

// Hand-rolled DeepCopy

func (in *SmolAgentPlatform) DeepCopyInto(out *SmolAgentPlatform) {
	*out = *in
...
func (in *SmolAgentPlatform) DeepCopy() *SmolAgentPlatform {
	if in == nil {
		return nil
	}
	out := new(SmolAgentPlatform)
	in.DeepCopyInto(out)
	return out
}
func (in *SmolAgentPlatform) DeepCopyObject() runtime.Object { return in.DeepCopy() }

func (in *SmolAgentPlatformList) DeepCopyInto(out *SmolAgentPlatformList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		out.Items = make([]SmolAgentPlatform, len(in.Items))
		for i := range in.Items {
			in.Items[i].DeepCopyInto(&out.Items[i])
		}
	}
}
func (in *SmolAgentPlatformList) DeepCopy() *SmolAgentPlatformList {
	if in == nil {
		return nil
	}
	out := new(SmolAgentPlatformList)
	in.DeepCopyInto(out)
	return out
}
func (in *SmolAgentPlatformList) DeepCopyObject() runtime.Object { return in.DeepCopy() }

func (in *SmolAgentPlatformSpec) DeepCopyInto(out *SmolAgentPlatformSpec) {
	*out = *in
...
func (in *SmolAgentPlatformStatus) DeepCopyInto(out *SmolAgentPlatformStatus) {
	*out = *in
...
func init() {
	SchemeBuilder.Register(&SmolAgentPlatform{}, &SmolAgentPlatformList{})
}
