...
// KnativeAgent into a controller-runtime Manager.
//
...
func SetupAgentWebhook(mgr ctrl.Manager, platformName string) error {
	...
	return ctrl.NewWebhookManagedBy(mgr, &v1.KnativeAgent{}).
		WithValidator(w).
		WithDefaulter(w).
		Complete()
}
...
// the policy gate.
func (w *agentWebhook) fetchPlatform(ctx context.Context) (*v1.KnativeAgentPlatform, error) {
...
func (w *agentWebhook) Default(ctx context.Context, cr *v1.KnativeAgent) error {
...
func (w *agentWebhook) ValidateCreate(ctx context.Context, cr *v1.KnativeAgent) (admission.Warnings, error) {
	return w.validate(ctx, cr)
}

// ValidateUpdate implements webhook.CustomValidator.
func (w *agentWebhook) ValidateUpdate(ctx context.Context, _, newObj *v1.KnativeAgent) (admission.Warnings, error) {
	return w.validate(ctx, newObj)
}

// ValidateDelete implements webhook.CustomValidator.
func (w *agentWebhook) ValidateDelete(_ context.Context, _ *v1.KnativeAgent) (admission.Warnings, error) {
	return nil, nil
}

func (w *agentWebhook) validate(ctx context.Context, cr *v1.KnativeAgent) (admission.Warnings, error) {
	platform, err := w.fetchPlatform(ctx)
	if err != nil {
		return nil, err
	}
...
func SetupPlatformWebhook(mgr ctrl.Manager, singletonName string) error {
	...
	return ctrl.NewWebhookManagedBy(mgr, &v1.KnativeAgentPlatform{}).
		WithValidator(w).
		Complete()
}
...
func (w *platformWebhook) ValidateCreate(_ context.Context, p *v1.KnativeAgentPlatform) (admission.Warnings, error) {
	return nil, ValidatePlatformSingleton(p, w.singletonName)
}

func (w *platformWebhook) ValidateUpdate(_ context.Context, _, newObj *v1.KnativeAgentPlatform) (admission.Warnings, error) {
	return nil, ValidatePlatformSingleton(newObj, w.singletonName)
}

func (w *platformWebhook) ValidateDelete(_ context.Context, _ *v1.KnativeAgentPlatform) (admission.Warnings, error) {
	return nil, nil
}
