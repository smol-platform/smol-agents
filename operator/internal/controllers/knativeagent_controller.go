...
import (
	...
	"github.com/stigen/knative-agents/operator/internal/controllers/features"
	"github.com/stigen/knative-agents/operator/internal/events"
	"github.com/stigen/knative-agents/operator/internal/metrics"
	flib "github.com/stigen/knative-agents/operator/pkg/features"
)

// KnativeAgentReconciler is the top-level controller. It dispatches to
// each FeatureReconciler in registration order and folds results into
// Status.
type KnativeAgentReconciler struct {
	client.Client
	...
	// PlatformName is the singleton KnativeAgentPlatform name. Defaults
	// to "default" if unset.
	PlatformName string
...
func (r *KnativeAgentReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	if r.Events == nil {
		r.Events = events.NewRecorder(mgr.GetEventRecorderFor("knativeagent-controller"))
	}
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&v1.KnativeAgent{}, builder.WithPredicates(predicate.GenerationChangedPredicate{})).
...
func (r *KnativeAgentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	logger := log.FromContext(ctx).WithValues("knativeagent", req.NamespacedName)

	startedAt := time.Now()
	defer func() {
		metrics.ReconcileDuration.WithLabelValues("knativeagent").
...
func (r *KnativeAgentReconciler) recordMetrics(cr *v1.KnativeAgent, results []FeatureResult) {
...
func (r *KnativeAgentReconciler) recordTransitionEvents(cr *v1.KnativeAgent, results []FeatureResult) {
	if r.Events == nil {
		return
	}
...
// the loop.
func (r *KnativeAgentReconciler) runReconcilers(ctx context.Context, cr *v1.KnativeAgent, platform *v1.KnativeAgentPlatform) ([]FeatureResult, []client.Object) {
...
func (r *KnativeAgentReconciler) applyOwned(ctx context.Context, cr *v1.KnativeAgent, desired client.Object) error {
...
var errPlatformAbsent = errors.New("controllers: KnativeAgentPlatform not found")

func (r *KnativeAgentReconciler) fetchPlatform(ctx context.Context) (*v1.KnativeAgentPlatform, error) {
