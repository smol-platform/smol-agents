...
- [ ] 5. Proxy credential-injection mode
...
- [ ] 6. AgentNetwork CRD additions + validation
...
- [ ] 7. Security tests (the whole point)
...
- [ ] 8. e2e: fake-github + R-E2E-SCN-SECRETLESS
