# Product Overview — knative-agents-agent-model

## Product Purpose

This spec defines **what an "agent" is** on the knative-agents platform
...
It is a peer to (not derived from) `knative-agents-platform` and
`knative-agents-operator`: those describe the *substrate*; this spec
