...
#
# Workloads:
#   - fake-gateway: SPIFFE ID spiffe://smol-agents.ai/ns/tenant-a/sa/fake-gateway
#   - test-driver: SPIFFE ID spiffe://smol-agents.ai/ns/tenant-a/sa/agent
#
...
/opt/spire/bin/spire-server entry create \
  ...
  -parentID spiffe://smol-agents.ai/spire/agent/join_token/$(cat /run/spire/data/agent-token 2>/dev/null || echo PLACEHOLDER) \
