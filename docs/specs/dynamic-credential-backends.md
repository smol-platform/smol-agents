...
> **✅ Decisions resolved 2026-06-03 — see [decisions.md](../design/decisions.md).** D8: a **`DynamicCredentialPolicy` CRD, operator-granted** (declarative; tenants reference, cannot self-grant) — replaces inline-Go. D1 makes this mandatory for multi-tenant. Where this doc still says OPEN/PROPOSED and conflicts, the decision log wins.
